...
class TypeInUSer extends StatelessWidget {
  const TypeInUSer({Key? key}) : super(key: key);
        ...
        return SizedBox(
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context, index) => TextButton(
                ...
                builder: (context) =>
                    TransactionDialog(onClickedDone: addTransaction, nameUser: model.user!.name, nameCategory: types[index]),
              ));},
                  )),
        );
      },
